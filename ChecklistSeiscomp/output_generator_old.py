...
def generate_excel(filename, response, metadata, data1, data2):
    ...
    update_jam_12(data1['gaps'], data1['spikes'], data1['blanks'])
    update_jam_00(data2['gaps'], data2['spikes'], data2['blanks'])
